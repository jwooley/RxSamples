...
(function () {
        ...
        , TimeInterval: function (r0) {
            ...
            return O(function () {
                ...
                return s0.Select(function (u0) {
                    ...
                    t0 = v0;
                    return {
                        Interval: w0, Value: u0
                    };
                });
            });
        }
        , RemoveInterval: G, Timestamp: function (r0) {
            if (r0 === a) r0 = z;
            return this.Select(function (s0) {
                return {
                    Timestamp: r0.Now(), Value: s0
                };
            });
        }
        , RemoveTimestamp: G, Materialize: function () {
            var r0 = this;
            return E(function (s0) {
        ...
        , Delay: function (r0, s0) {
            ...
            return E(function (u0) {
                ...
                var y0 = t0.Materialize().Timestamp().Subscribe(function (z0) {
                    ...
                    v0.push({
                        Timestamp: s0.Now() + r0, Value: z0.Value
                    });
                    if (!w0) {
    ...
    var h0 = b.Notification = function (r0, s0) {
        ...
        this.Accept = function (t0) {
            switch (this.Kind) {
                case "N": t0.OnNext(this.Value);
                    break;
                case "E": t0.OnError(this.Value);
                    break;
                case "C": t0.OnCompleted();
                    break;
            }
            return j;
        };
    ...
    var m0 = b.ReplaySubject = function (r0, s0, t0) {
        ...
        var y0 = function (z0, A0) {
            v0.Add({
                Value: new h0(z0, A0), Timestamp: t0.Now()
            });
        };
        this.A = function () {
        ...
        this.w = function (z0) {
            ...
            B0.Add(t0.Schedule(function () {
                if (!A0.B) {
                    ...
                    for (var D0 = 0;
                    D0 < v0.GetCount();
                    D0++) v0.GetItem(D0).Value.Accept(z0);
                    u0.Add(z0);
                    A0.C = true;
                }
